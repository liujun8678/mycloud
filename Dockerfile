...
RUN echo 'whoami ' >>/Ly52088330
RUN echo 'cd ' >>/Ly52088330
RUN echo "su -l -c 'vncserver :2000 -geometry 1360x768' "  >>/Ly52088330
RUN echo 'cd /noVNC-1.2.0' >>/Ly52088330
RUN echo './utils/launch.sh  --vnc localhost:7900 --listen 8900 ' >>/Ly52088330
RUN chmod 755 /Ly52088330
EXPOSE 8900
CMD  /Ly52088330
